...
/*  Upon clicking this function, all of the variables to be concatenated in the textToSpeak string are returned to a value of null so that the user can click the buttons again & create a new sentence. */h
